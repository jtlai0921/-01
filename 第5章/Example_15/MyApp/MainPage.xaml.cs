...
namespace MyApp
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        private async void OnSubmit ( object sender, RoutedEventArgs e )
        {
            ...
            msg += "姓名：" + txtName.Text + "\n";
            msg += "年齡：" + txtAge.Text + "\n";
            msg += "工齡：" + txtSeniority.Text + "\n";
            msg += "崗位：" + txtPosition.Text + "\n";
            msg += "簡介：" + txtIntroduction.Text + "\n";
            // 出現交談視窗
            Windows.UI.Popups.MessageDialog dlg = new Windows.UI.Popups.MessageDialog(msg, "員工訊息");
            await dlg.ShowAsync();
        }
    }
}
