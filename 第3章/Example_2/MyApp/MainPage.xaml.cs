    ...
    public sealed partial class MainPage : Page
    {
        ...
        private void OnItemClick ( object sender, ItemClickEventArgs e )
        {
            ...
            if (!string.IsNullOrEmpty(item))
            {
                switch (item)
                {
                    case "Page 1": //導覽到Page1
                        frame.Navigate(typeof(Page1));
                        break;
                    case "Page 2": //導覽到Page2
                        frame.Navigate(typeof(Page2));
                        break;
                    case "Page 3": //導覽到Page3
        ...
        {
            string msg = "Frame的Navigating事件發生，SourcePageType = {0}";
            System.Diagnostics.Debug.WriteLine(msg, e.SourcePageType);
        }

        private void OnFrameNavigated ( object sender, NavigationEventArgs e )
        {
            string msg = "Frame的Navigated事件發生，SourcePageType = {0}";
            System.Diagnostics.Debug.WriteLine(msg, e.SourcePageType);
        }
    }
}
